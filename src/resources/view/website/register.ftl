...
<head>
    ...
    <link rel="stylesheet" href="<@url value='/assets/website/backend/css/login_style.css'/>" type="text/css"
          media="screen"/>
    <link rel="stylesheet" href="<@url value="/assets/website/css/bootstrap.min.css?v=1.1.0"/>" type="text/css"
          media="screen"/>
                                ...
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td height="60" colspan="4" align="left" valign="middle"
                                            style="background:url(http://obu3flkwk.bkt.clouddn.com/backend/images/icon2.jpg) no-repeat left center; padding:20px 0px; height:30px; line-height:30px; padding-left:30px;">
                                            每个手机只能申请一个账号
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width="106" height="60" align="right" valign="middle"><font color="#ff0000">*</font>个人账号：
                                        </td>
                                        <td colspan="2"><input
                                                style="border:1px solid #e7e6eb; height:30px; line-height:30px; width:280px;"
                                                type="text" name="username" id="username"
                                                data-reg="/^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/"
                                                placeholder="请输入11位手机号" required/></td>
                                        <td width="282"><font color="#999999">作为登录账号，请填写未注册过的手机</font></td>
                                    </tr>
                                    <tr>
                                        <td height="60" align="right" valign="middle"><font color="#ff0000">*</font>密码：
                                        </td>
                                        <td colspan="2"><input
                                                style="border:1px solid #e7e6eb; height:30px; line-height:30px; width:280px;"
                                                type="password" name="password" id="password"
                                                data-reg="/^[A-Za-z0-9]{6,16}$/" placeholder="请输入6-16位字母、数字组成的登录密码"
                                                required/></td>
                                        <td><font color="#999999">6~16个字符，包含字母，数字，下划线</font></td>
                                    </tr>
                                    <tr>
                                        <td height="60" align="right" valign="middle"><font color="#ff0000">*</font>确认密码：
                                        </td>
                                        <td colspan="2"><input
                                                style="border:1px solid #e7e6eb; height:30px; line-height:30px; width:280px;"
                                                type="password" name="confirmPassword" id="confirmPassword"
                                                data-reg="/^[A-Za-z0-9]{6,16}$/" placeholder="请再次输入登录密码" required/></td>
                                        <td><font color="#999999">请再次输入密码</font></td>
                                    </tr>
                                    <tr>
                                        <td height="60" align="right" valign="middle"><font color="#ff0000">*</font>验证码：
                                        </td>
                                        <td width="100"><input
                                                style="border:1px solid #e7e6eb; height:30px; line-height:30px; width:120px;"
                                                type="text" name="verCode" id="verCode"/></td>
                                        <td width="72">
                                            <input type="button" id="personal_msgsend" value="免费获取验证码"
                                                   onclick="javascript:settime(this);sendmsg(this.id);return false;"
                                                   style="border:1px solid #e7e6eb; height:30px; line-height:30px; width:120px;"/>
                                        </td>
                                                ...
                                                <tr>
                                                    <div id="checkeRadio">
                                                        <label class="radio-inline col-sm-3">
                                                            <input name="personType" type="radio" value="AUTOBOT"
                                                                   checked/>汽车人
                                                        </label>
                                                        <label class="radio-inline col-sm-3">
                                                            <input type="radio" name="personType" value="TRAINER"/>培训师
                                                        </label>
                                                    </div>
                                                </tr>
                                            </table>
                                    ...
                                    <tr>
                                        <td height="80" colspan="4" align="center" valign="middle"><input type="image"
                                                                                                          name="imageField"
                                                                                                          id="imageField"
                                                                                                          src="http://obu3flkwk.bkt.clouddn.com/backend/images/tj.jpg"
                                                                                                          onClick='javascript:personal_register();return false;'/>
                                        </td>
                                    </tr>
                                </table>
                            </form>
                        ...
                        <div id="item_con_1" style="display:none">
                            <form action="" id="company_loginform">
                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td width="106" height="60" align="right" valign="middle"><font color="#ff0000">*</font>企业账号：
                                        </td>
                                        <td colspan="2"><input
                                                style="30px;border:1px solid #e7e6eb; height:30px; line-height:30px; width:280px;"
                                                type="text" name="username" id="username"
                                                data-reg="/^(0|86|17951)?(13[0-9]|15[012356789]|17[678]|18[0-9]|14[57])[0-9]{8}$/"
                                                placeholder="请输入11位手机号" required/></td>
                                        <td width="282"><font color="#999999">作为登录账号，请填写未注册过的手机</font></td>
                                    ...
                                    <tr>
                                        ...
                                        <td width="72" align="left">
                                            <input type="button" id="company_msgsend"
                                                   style="border:1px solid #e7e6eb; height:30px; line-height:30px; width:120px;"
                                                   value="免费获取验证码"
                                                   onclick="settime(this);sendmsg(this.id);return false;"/></td>
                                        <td><font color="#999999">请输入手机验证码</font></td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td height="60" colspan="4" align="center" valign="middle">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                <tr>
                                                    <div id="checkeRadio">
                                                        <label class="radio-inline col-sm-3">
                                                            <input name="companyType" id="companyType" type="radio"
                                                                   value="COMPANY" checked/>培训企业
                                                        </label>
                                                        <label class="radio-inline col-sm-3">
                                                            <input type="radio" name="companyType" id="companyType"
                                                                   value="STORE"/>汽车公司
                                                        </label>
                                                    </div>
                                                </tr>
                                    ...
                                    <tr>
                                        <td height="80" colspan="4" align="center" valign="middle"><img id="imageField"
                                                                                                        src="http://obu3flkwk.bkt.clouddn.com/backend/images/tj.jpg"
                                                                                                        onClick='company_register()'/>
                                        </td>
                                    </tr>
                                </table>
                            </form>
...
<script>
    ...
    function personal_register() {
        var form_data = {};
        var errMsg = $("#personal_loginform .errMsg")[0];
        ...
        form_data["personType"] = $("input[name='personType']:checked").val();
    ...
    function company_register() {
        var form_data = {};
        var errMsg = $("#company_loginform .errMsg")[0];
